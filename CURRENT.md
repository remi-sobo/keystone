...
| 1 | Operability: 1A admin UI, 1B engagement builder, 1C one template, 1D first-run | 1A BUILT (2026-07-09; Remi approved the spec's four gates as recommended and pulled the build forward): migration 0009, `/settings/members`, designed invite emails, revocation through the predicates. 390px live run owed with the other rings; invite sends wait on RESEND_API_KEY. 1B specced (`specs/keystone-v2-engagement-builder.md`, four CONFIRM gates open); build on approval |
