...
export function buildExtractionRequest(
  ...
  const system = [
    ...
    'items that were not said.',
    'The engagement record holds decisions, commitments, and work',
    'product, nothing else, and every client member can read it. Never',
    'extract: personnel opinions or assessments shared in confidence,',
    'past-staff history, the personal finances of anyone named,',
    'personal details about named donors, internal financial operations',
    '(runway, rent, leases), board matters, or personal chatter. When a',
    'passage is one of these, leave it out entirely; it belongs in no',
    'field.',
    'Voice: warm, direct, short sentences, no',
